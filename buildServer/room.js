        ...
        this.startVBrowser = (socket, data) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (config_1.default.STRIPE_SECRET_KEY && data && data.uid && data.token) {
                ...
                if (decoded === null || decoded === void 0 ? void 0 : decoded.email) {
                    ...
                    if ((_o = (_m = customer === null || customer === void 0 ? void 0 : customer.subscriptions) === null || _m === void 0 ? void 0 : _m.data) === null || _o === void 0 ? void 0 : _o.find((sub) => (sub === null || sub === void 0 ? void 0 : sub.status) === 'active')) {
                        ...
                        if ((_q = data.options) === null || _q === void 0 ? void 0 : _q.region) {
                            region = (_r = data.options) === null || _r === void 0 ? void 0 : _r.region;
                        }
                    }
                }
            }
            if (config_1.default.RECAPTCHA_SECRET_KEY) {
                try {
                    ...
                    const isLowScore = ((_s = validation === null || validation === void 0 ? void 0 : validation.data) === null || _s === void 0 ? void 0 : _s.score) < 0.1;
                    const failed = ((_t = validation === null || validation === void 0 ? void 0 : validation.data) === null || _t === void 0 ? void 0 : _t.success) === false;
                    console.log('[RECAPTCHA] score: ', (_u = validation === null || validation === void 0 ? void 0 : validation.data) === null || _u === void 0 ? void 0 : _u.score);
            ...
            const assignmentResp = yield axios_1.default.post('http://localhost:' + config_1.default.VMWORKER_PORT + '/assignVM', {
                provider: config_1.default.VM_MANAGER_ID,
                isLarge,
                region,
                uid,
            });
