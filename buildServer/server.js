...
app.get('/health/:metric', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const stats = yield getStats();
    const result = (_b = (_a = stats.vmManagerStats[req.params.metric]) === null || _a === void 0 ? void 0 : _a.availableVBrowsers) === null || _b === void 0 ? void 0 : _b.length;
...
app.get('/metadata', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i <= Object.keys(vmManagers).length; i++) {
        ...
        if (value) {
            ...
            const minSize = (_p = value === null || value === void 0 ? void 0 : value.getMinSize()) !== null && _p !== void 0 ? _p : 0;
            const limitSize = (_q = value === null || value === void 0 ? void 0 : value.getLimitSize()) !== null && _q !== void 0 ? _q : 0;
...
app.get('/resolveRoom/:vanity', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (postgres === null || postgres === void 0 ? void 0 : postgres.query(`SELECT "roomId", vanity from room WHERE LOWER(vanity) = $1`, [(_t = vanity === null || vanity === void 0 ? void 0 : vanity.toLowerCase()) !== null && _t !== void 0 ? _t : '']));
...
app.get('/listRooms', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _u, _v, _w;
    const decoded = yield (0, firebase_1.validateUserToken)((_u = req.query) === null || _u === void 0 ? void 0 : _u.uid, (_v = req.query) === null || _v === void 0 ? void 0 : _v.token);
    if (!decoded) {
        return res.status(400).json({ error: 'invalid user token' });
    }
    ...
    return res.json((_w = result === null || result === void 0 ? void 0 : result.rows) !== null && _w !== void 0 ? _w : []);
}));
...
function getStats() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const dbRoomData = (_a = (yield (postgres === null || postgres === void 0 ? void 0 : postgres.query(`SELECT "roomId", "creationTime", "lastUpdateTime", vanity, "isSubRoom", owner, password from room WHERE "lastUpdateTime" > NOW() - INTERVAL '30 day' ORDER BY "creationTime" DESC`)))) === null || _a === void 0 ? void 0 : _a.rows;
