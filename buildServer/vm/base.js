...
class VMManager {
    constructor(large, region, limitSize, minSize, minBuffer) {
        this.isLarge = false;
        this.region = '';
        this.currentSize = 0;
        this.limitSize = 0;
        ...
        this.runBackgroundJobs = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const updateSize = () => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.redis.setex(this.getRedisPoolSizeKey(), 2 * 60, this.currentSize);
            ...
            const cleanupVMGroup = () => __awaiter(this, void 0, void 0, function* () {
                ...
                console.log('[CLEANUP] %s found %s VMs, usedKeys %s, availableKeys %s, stagingKeys %s', this.getRedisQueueKey(), allVMs.length, usedKeys.length, availableKeys.length, stagingKeys.length);
                for (let i = 0; i < allVMs.length; i++) {
                ...
                try {
                    ...
                    const stagingPromises = stagingKeys.map((id) => {
                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            let ready = false;
                            let vmCached = yield this.redis.get(this.getRedisHostCacheKey() + ':' + id);
                            let host = (vmCached === null || vmCached === void 0 ? void 0 : vmCached.startsWith('{'))
                            ...
                            if (!host && (retryCount === 1 || retryCount % 5 === 0)) {
                                try {
                                    ...
                                    if (vm && vm.host) {
                                        ...
                                        yield this.redis.setex(this.getRedisHostCacheKey() + ':' + id, 3 * 3600, JSON.stringify(vm));
                                    }
                                }
                                catch (e) {
