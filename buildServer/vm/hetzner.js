    ...
    constructor() {
        ...
        this.attachToNetwork = (id) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (((_c = response.data.server.private_net) === null || _c === void 0 ? void 0 : _c[0]) == null) {
                    yield (0, axios_1.default)({
                        method: 'POST',
        ...
        this.updateSnapshot = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const response3 = yield (0, axios_1.default)('http://' + ((_f = (_e = response.data.server.public_net) === null || _e === void 0 ? void 0 : _e.ipv4) === null || _f === void 0 ? void 0 : _f.ip) + ':5000/healthz');
